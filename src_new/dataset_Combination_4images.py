...
class SurCombineFeaturing(SurCombine):
    ...
    def collate_fn(self, data):
        ...
        # dic = [0, 6, 11, 12, 38, 42, 43, 46, 61, 68, 69, 82, 83, 92, 96, 97, 101, 109, 111, 112, 113, 114, 115, 116, 119, 120, 121, 124, 125, 140, 141, 142, 143, 144, 146, 147, 148, 149, 150, 155, 156, 157, 158, 160, 161, 162, 163, 165, 166, 167, 168, 169, 170, 171, 172, 174, 175, 176, 177, 178, 179, 180, 181, 182, 183, 184, 185, 186, 187, 188, 191, 192, 193, 194, 195, 198, 199, 203, 206, 207, 208, 210, 211, 212, 213, 225, 252, 260, 266, 322, 332, 417, 418, 429, 431, 433, 434, 436, 437, 439, 440, 441, 442, 443]
        # features_sel = []
        # for i in dic:
        ...
        '''
        Used to output the features
        '''
        with open("features_flair.csv","a",newline='') as csvfile:
